...
def make_parser():
    ...
    # Data args
    parser.add_argument("--dataset", type=str, default="mot20_half")
    parser.add_argument("--data_path", type=str, default="/DATA/Tawheed/MOTDatasets/mot20_half/train/")
    parser.add_argument("--pickle_path", type=str, default="/home/tawheed/MOT/mot20_half_train.pickle")
    parser.add_argument("--output_path", type=str, default="/DATA/Tawheed/track_files/pickle_path/features/mot20_half_train.pickle")
    parser.add_argument("--config_path", type=str, default="configs/MOT20_half/sbs_S50.yml")
    parser.add_argument("--weight_path", type=str, default="weights/mot20_half_sbs_S50.pth")
