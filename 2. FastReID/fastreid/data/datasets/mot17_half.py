...
class MOT17_half(ImageDataset):
    dataset_dir = "mot17_half"
    dataset_name = "mot17_half"

    def __init__(self, root='datasets', **kwargs):
        self.dataset_dir = osp.join('/DATA/Tawheed/MOTDatasets/', self.dataset_dir)
        ...
        super(MOT17_half, self).__init__(train, [], [], **kwargs)
