...
def make_parser():
    ...
    parser.add_argument("--association_checkpoint", type=str, default="/home/tawheed/MOT/TrackTrack/cross_attn_matcher/better/best_model_loss_0.0419.pth")
...
def track(detections, detections_95, data_path, result_folder, mode):
    ...
    for vid_name in detections.keys():
        ...
        print(f'Max track id: {max_trackid}')
